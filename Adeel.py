# Decompile by Shakil Ahmmed(Tools By Cobra-Linux Shakil Ahmmed)
# Dont ader restiment with Shakil
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.rm('https://raw.githubusercontent.com/EsanAhmedAbir/OldCrack/main/Premium.txt').text
			if basesplit in plr:
				key = basesplit
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :  \n")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : https://facebook.com/shakil.vau404/ ")
		print(" [*] YouTube   : Shakil-Official/ ")
		exit(" [*] GitHub    : https://github.com/Shakilvau143/ ")
	else:
		Main()
